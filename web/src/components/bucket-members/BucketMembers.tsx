...
import { ShareLinksList } from "@/components/bucket-members/components/ShareLinksList";
        ...
        <Tabs defaultValue="members">
          <TabsList className="w-full">
            <TabsTrigger value="members" className="flex-1">
              {t("bucket.settings.shares.tab_members")}
            </TabsTrigger>
            <TabsTrigger value="shares" className="flex-1">
              {t("bucket.settings.shares.tab_shares")}
            </TabsTrigger>
          </TabsList>
                ...
                <div className="flex gap-3">
                  ...
                  <ButtonGroup>
                    <Button
                      ...
                      disabled={
                        !newMemberEmail.trim() ||
                        !EMAIL_REGEX.test(newMemberEmail)
                      }
                      variant="outline"
                      size="icon"
                    >
