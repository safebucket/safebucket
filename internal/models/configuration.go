...
type AppConfiguration struct {
	...
	AuthenticatedRateLimit   int                 `mapstructure:"authenticated_rate_limit"   validate:"gte=1"`
	UnauthenticatedRateLimit int                 `mapstructure:"unauthenticated_rate_limit" validate:"gte=1"`
