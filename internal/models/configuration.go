...
type AppConfiguration struct {
	...
	AllowCustomShareLinks            bool                   `mapstructure:"allow_custom_share_links"`
...
type ProfilingConfiguration struct {
	...
	Type      string                  `mapstructure:"type"      validate:"required_if=Enabled true,omitempty,oneof=pyroscope"`
	Pyroscope *PyroscopeConfiguration `mapstructure:"pyroscope" validate:"required_if=Type pyroscope"`
}
