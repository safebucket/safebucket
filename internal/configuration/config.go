...
func loadConditionalDefaults(k *koanf.Koanf) {
	...
	if k.String("app.tracing.type") == "pyroscope" {
		setIfMissing(k, "app.tracing.pyroscope.application_name", "safebucket")
		setIfMissing(k, "app.tracing.pyroscope.upload_rate", 15)
	}
}
