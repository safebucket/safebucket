...
func GetUserMembership(db *gorm.DB, userID uuid.UUID, bucketID uuid.UUID) (*models.Membership, error) {
...
func UpdateMembership(db *gorm.DB, userID uuid.UUID, bucketID uuid.UUID, newGroup models.Group) error {
...
func HasBucketAccess(db *gorm.DB, userID uuid.UUID, bucketID uuid.UUID, requiredGroup models.Group) (bool, error) {
